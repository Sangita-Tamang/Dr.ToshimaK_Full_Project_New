        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              <a 
                className="social-facebook social-tooltip" 
                href={SOCIAL_LINKS.facebookSecretariat} 
                target="_blank" 
                rel="noreferrer" 
                aria-label="Dr. Toshima Karki Secretariat FB" 
                data-tooltip="Dr. Toshima Karki Secretariat FB"
              >
                <i className="fa-brands fa-facebook-f"></i>
              </a>
              <a 
                className="social-facebook social-tooltip" 
                href={SOCIAL_LINKS.facebookPersonal} 
                target="_blank" 
                rel="noreferrer" 
                aria-label="Personal Facebook" 
                data-tooltip="Personal Facebook"
              >
                <i className="fa-brands fa-facebook-f"></i>
              </a>
              <a 
                className="social-linkedin social-tooltip" 
              ...
              <a 
                className="social-youtube social-tooltip" 
              ...
              <a 
                className="social-x social-tooltip" 
              ...
              >
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.64 7.584H.47l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932Zm-1.29 19.493h2.04L6.486 3.24H4.298L17.61 20.646Z" /></svg>
              </a>
            </div>
          </div>
